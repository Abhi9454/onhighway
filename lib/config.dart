...
class AppConfig{
  final String appName = "onHighway";
  final Color primary = Color(0XFF091c2f);    // Dark Blue
  ...
  final String webSiteLink = 'https://onhighway.in';
  final String customerSupportNumber = '18002588073';
}